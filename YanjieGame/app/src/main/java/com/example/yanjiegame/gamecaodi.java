...
public class gamecaodi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamecaodi);
            ...
            public void onClick(View v) {
                ...
                switch(number1){
                    ...
                    case 20:
                        ...
                        break;
                    default:
                        Intent intent1=new Intent(gamecaodi.this,gamezhaoze.class);
    ...
    protected void onResume(){
        super.onResume();
        mediaPlayer = MediaPlayer.create(this,R.raw.thewayistillloveyou);
